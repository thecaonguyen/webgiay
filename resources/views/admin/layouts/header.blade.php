    ...
    <div class="container-fluid">
        ...
        <a href="index.html" class="navbar-brand mr-0 mr-md-2 logo">
            <span class="logo-lg">
                ...
                <span class="d-inline h5 ml-1 text-logo">SHOP</span>
            </span>
            <span class="logo-sm">
                <img src="/backend/assets/images/logo.png" alt="" height="24">
            </span>
            ...
            <li class="dropdown d-none d-lg-block" data-toggle="tooltip" data-placement="left" title="Change language">
                ...
                <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="/backend/assets/images/flags/germany.jpg" alt="user-image" class="mr-2" height="12"> <span
                            class="align-middle">German</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="/backend/assets/images/flags/italy.jpg" alt="user-image" class="mr-2" height="12"> <span
                            class="align-middle">Italian</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="/backend/assets/images/flags/spain.jpg" alt="user-image" class="mr-2" height="12"> <span
                            class="align-middle">Spanish</span>
                    </a>

                    <!-- item-->
                    <a href="javascript:void(0);" class="dropdown-item notify-item">
                        <img src="/backend/assets/images/flags/russia.jpg" alt="user-image" class="mr-2" height="12"> <span
            ...
            <li class="dropdown notification-list align-self-center profile-dropdown">
                <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button"
                    ...
                    <div class="media user-profile ">
                        <img src="/backend/assets/images/users/avatar-7.jpg" alt="user-image" class="rounded-circle align-self-center" />
